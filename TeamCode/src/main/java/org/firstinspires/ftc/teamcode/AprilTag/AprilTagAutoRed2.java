...
@Autonomous
public class AprilTagAutoRed2 extends LinearOpMode {
    ...
    Trajectory Park2 = drivetrain.trajectoryBuilder(Red2Signal1.end()).back(20).build();
    Trajectory Park3 = drivetrain.trajectoryBuilder(Red2Signal1.end()).back(42).build();
