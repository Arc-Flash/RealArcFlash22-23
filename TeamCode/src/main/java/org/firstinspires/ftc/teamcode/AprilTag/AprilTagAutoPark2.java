...
//    private Servo Claw;
    ...
    public void runOpMode() {
        ...
        Trajectory Park2 = drive.trajectoryBuilder(Red1Signal1.end()).strafeRight(45).build();
        Trajectory Park3 = drive.trajectoryBuilder(Red1Signal1.end()).strafeLeft(45).build();
