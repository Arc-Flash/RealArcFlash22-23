...
public class AprilTagAutoBlue1 extends LinearOpMode {
    ...
    Trajectory Park2 = drivetrain.trajectoryBuilder(Blue1Signal1.end()).back(20).build();
    Trajectory Park3 = drivetrain.trajectoryBuilder(Blue1Signal1.end()).back(42).build();
